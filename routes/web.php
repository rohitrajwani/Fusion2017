...
Route::get('/SRS/student_home','HomePageController@studentHome');
Route::get('/SRS/student/register','RegisterController@studentRegister');
Route::get('/SRS/student/register_course','RegisterController@courseRegister');
Route::get('/SRS/student/update_course','RegisterController@courseUpdate');
Route::get('/SRS/student/register_course/view_course','RegisterController@viewCourse');
Route::post('/SRS/toDB','RegisterController@submitf');
