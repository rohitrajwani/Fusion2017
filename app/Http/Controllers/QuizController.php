...
class QuizController extends Controller
{
    ...
    {
    	$quizzes=Quiz::all();
    	return view('online_quiz.quizzes',compact('quizzes'));
    }

    public function edit(Quiz $quiz)
    {
    	return view('online_quiz.edit_quiz',compact('quiz'));
    }

    public function question(Question $question)
    {
    	return view('online_quiz.question',compact('question'));
    }

    public function addquestion()
    {
    	return view('online_quiz.addquestion');
    }
    ...
    public function savequestion(Request $request)
    {
    	...
    	return view('online_quiz.quiz_questions',compact('quiz'));
    }


    public function give_quiz(Quiz $quiz,$student_id)
    {
        return view('online_quiz.give_quiz',compact('quiz'),compact('student_id'));
    }

    public function answer_question(Question $ques,$student_id)
    {
        return view('online_quiz.answer_question',compact('ques'),compact('student_id'));
    }
    ...
    {
        return view('online_quiz.facultyPage',compact('faculty_id'));
    }

    public function faculty_quiz($faculty_id)
    {
        return view('online_quiz.pfacultyPage',compact('faculty_id'));
    }

    public function hostquiz()
    {
        return view('online_quiz.phostQuiz');
    }

    public function student_quiz($student_id)
    {
        return view('online_quiz.pstudentPage',compact('student_id'));
    }

    public function studenthome($student_id)
    {
        return view('online_quiz.studentPage',compact('student_id'));
    }
    ...
    {
        return view('online_quiz.view_profile',compact('student_id'));
    }

    public function view_result(Quiz $quiz)
    {
        return view('online_quiz.pviewResults',compact('quiz'));
    }
