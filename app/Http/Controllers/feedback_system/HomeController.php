...
return view('home1');
    ...
    {
        $id = 2014043;///assumed id to be taken by session.
    ...
    public function feedback($cour,$facid,$id,$type1)  // feedback page
    {
        ...
        return view('feedback',['semester'=>$semester,'suggestion'=>$suggestion,'questions'=>$questions,'cour'=>$cour,'facid'=>$facid,'id'=>$id,'type1'=>$type1]);
    }
...
public function view($type)  //view page
    {
        ...
        return view('view',['faculty'=>$faculty,'type'=>$type]);
  ...
  public function feedbackinsert(Request $req)  // feedback insert function
    ...
    return view('course',['course'=>$course, 'fid'=>$fid,'type'=>$type]);
    ...
    public function review1($fid,$cid,$type)  //review page
    {
        ...
        return view('review',['fid'=>$fid,'cid'=>$cid, 'questions'=>$questions,'suggestion'=>$suggestion,'type'=>$type]);
