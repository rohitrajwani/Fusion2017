...
{
	public function store(Request $request,$clubname)
	{
		...
		$book->requester_type="Club_Admin";
		$book->status="1";
		...
		return redirect('/event_organizing/clubadmin/'.$clubname);
	}

	public function update(Request $request, $clubname, $id)
    {
        $this->validate($request, [
	...
	public function destroy($clubname,$id)
	{
