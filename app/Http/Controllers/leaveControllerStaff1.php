...
class leaveControllerStaff1 extends Controller
{
    public function homeStaff()//Home Page for Staff
    {
        ...
        return view('pages.homePageStaffLGO',['staffdet'=>$staffdet,'leavedet'=>$leavedet]);
    }
    ...
    public function apply()//Leave Application Form for Faculty or Staff
    {
        ...
        $staffdet = DB::table('staff')->where('staff_id','=',$un)->first();
        $leavedet = DB::table('balance_leaves')->where('user_id','=',$un)->first();
        return view('pages.leaveApplication1LGO',['staffdet'=>$staffdet,'leavedet'=>$leavedet]);
    }
    ...
    { 
        ...
        return view('pages.currentLeaveStatusStaffLGO',['staffdet'=>$staffdet,'leavedet'=>$ldet]);
    }
    ...
    public function status()
    {
        ...
        return view('pages.currentLeaveStatusStaffLGO',['staffdet'=>$staffdet,'leavedet'=>$leavedet]);
    }
    ...
    public function history()
    {
        ...
        return view('pages.leaveHistoryStaffLGO',['leavedet'=>$leavedet,'staffdet'=>$staffdet]);
    }
    ...
    public function req()
    {
        ...
        return view('pages.leaveRequestsStaff',['leavedet'=>$leavedet,'staffdet'=>$staffdet]);
    }
