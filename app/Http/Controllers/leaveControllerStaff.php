...
class leaveControllerStaff extends Controller
{
    public function homeStaff()//Home Page for Staff
    {
        ...
        return view('pages.homePageStaff',['staffdet'=>$staffdet,'leavedet'=>$leavedet]);
    }
    ...
    public function apply()//Leave Application Form for Faculty or Staff
    {
    	...
    	return view('pages.leaveApplication1',['staffdet'=>$staffdet,'leavedet'=>$leavedet]);
    }
    ...
    public function insert(Request $r)
    {
        ...
        return view('pages.currentLeaveStatusStaff',['staffdet'=>$staffdet,'leavedet'=>$ldet]);
    }
    ...
    public function history()
    {
        ...
        return view('pages.leaveHistoryStaff',['leavedet'=>$leavedet]);
    }
}