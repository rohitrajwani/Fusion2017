    ...
    public function up()
    {
      ...
      Schema::create('Mess_Order', function(Blueprint $table) {
        ...
        Schema::create('faculty_floats_pbi', function(Blueprint $table) {
            ...
            $table->primary('pbi_id');
            $table->foreign('pbi_id')->references('pbi_id')->on('pbi_topics');
        	$table->timestamps();
        });
        ...
        Schema::create('pbi_reports', function(Blueprint $table) {
             ...
             $table->string('type',50);
             $table->string('path',1000);
             $table->foreign('student_id')->references('student_id')->on('all_students');
             $table->foreign('faculty_name')->references('faculty_name')->on('faculty');
             $table->timestamps();
        });
         ...
         Schema::create('pbi_status', function(Blueprint $table) {
             ...
             $table->foreign('pbi_name')->references('pbi_name')->on('pbi_topics');
             $table->timestamps();
        });
