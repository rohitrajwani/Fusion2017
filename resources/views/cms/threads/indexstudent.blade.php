...
@section('cms_content')
            ...
            <div class="container col s12 " style="width:90%">
                <div class="section col s12" style="padding:20px 0px;background-color:rgba(211, 211, 211, 0.47)">
					...
					<div class="col s3">
							<a href="{{ route('newthreadstudent',['sid'=>$student->student_id]) }}" class="waves-effect btn col">+ New Thread</a>		
					</div>
                ...
                <div class="section col s12">
                    ...
                    <table class="bordered highlight">
						...
						@foreach($questionf as $question)
                          <tr>
                            <td ><a href="{{ route('onethreadstudent',['sid'=>$student->student_id,'tid'=>$question->question_id]) }}">{{$question->question}}</a></td>
							<td>{{ $question->name }}</td>
                          </tr>
                        @endforeach
