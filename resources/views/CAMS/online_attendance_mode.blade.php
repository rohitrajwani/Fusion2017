...
<br>
 @if($alert = Session::get('alert'))
	...
	<form action="/CAMS/store-attendance_online/{{$coursename}}" method="post">
	 ...
	 <table class="responsive-table centered " align="center" border="2 px solid red">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><input type="checkbox" class="filled-in" id="{{$student->roll_no}}" name="{{$student->roll_no}}" checked="checked" /><label for="{{$student->roll_no}}"></label></td>
          </tr>
		  @endforeach
        </tbody>
      </table>
