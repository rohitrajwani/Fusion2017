...
@section('content')
			<div class="main-container row">
				<h4 class="col s12 m8 offset-m2 ">IIITDMJ PROFICIENCY PRIZE</h4></br>
				<br>
				<br><br><br><br><br>
				<h6 class="col s12 m6">IIITDMJ PROFICIENCY PRIZE APPLICANTS</h6>
				</br></br>
    ...
    @foreach($result as $a)
      ...
      <tr>
       ...
       ?>
		...
		<td>
		<form method="POST" action="iiitdmj_prof_a/{{$scholarship_id}}/{{$student_id}}">
