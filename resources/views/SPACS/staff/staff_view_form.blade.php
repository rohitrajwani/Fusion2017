...
$application=DB::table('awards_applications')->where([['student_id',$user_id],['scholarship_id',$scholarship_id],])->get();
?>
...
<tr>
 ...
 <tr>
      <td><li>Name of Brother*:<br>
        ...
        <td> {{$application[0]->brother_name}}<br>
      </td>
 </tr>
...
<tr>
      <td>Occupation of Brother*:<br>
        ...
        <td>{{$application[0]->b_occupation}}<br>
      </td>
 </tr>
 <tr>
      <td><li>Name of Sister*:<br>
        </li></td>
        <td> {{$application[0]->sister_name}}<br>
      </td>
 </tr>
 <tr>
      <td>Occupation of Sister*:<br>
        </td>
        <td>{{$application[0]->s_occupation}}<br>
      </td>
 </tr>
 </ol>        
 <!----- Address ---------------------------------------------------------->
...
<td>a)Name and address of firm/Organization/Shop: {{$application[0]->firm_address}}<br>
b)Nature of Trade/Business:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp {{$application[0]->nature_of_business}}<br>

c)Trade/Prof. License/Reg No: &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp{{$application[0]->registration_no}}<br>
d)Sales Tax/Commercial Tax No/Zone/: &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp{{$application[0]->tax_reg_no}}<br>
</td>
</tr>
<tr>
