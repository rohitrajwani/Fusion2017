...
@section('content')
			<div class="main-container row">
				<h4 class="col s12 m8 offset-m2 ">DIRECTOR SILVER MEDAL CULTURAL</h4></br>
				<br>
				<br><br><br><br><br>
				<h5 class="col s12 m6">DIRECTOR SILVER MEDAL CULTURAL APPLICANTS</h5>
				</br></br>
    ...
    @foreach($result as $a)
      ...
      <tr>
       ...
       ?>
		...
		<td>
		<form method="POST" action="dir_sil_cul_a/{{$scholarship_id}}/{{$student_id}}">
