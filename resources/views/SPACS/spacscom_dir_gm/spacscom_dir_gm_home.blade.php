...
@section('SPACS_content')
			<div class="main-container row">
				<h4 class="col s12 m8 offset-m2 ">DIRECTOR GOLD MEDAL</h4></br>
				<br>
				<br><br><br><br><br>
				<h6 class="col s12 m6">DIRECTOR GOLD MEDAL APPLICANTS</h6>
				</br></br>
...
<table class="bordered highlight">
      ...
      <tr>
       ...
       ?>
		...
		<td>	
						...
						<form method="POST" action="/SPACS/dir_gm_m/{{$scholarship_id}}/{{$student_id}}">
    ...
    <td><a href="/SPACS/spacscom_dir_gm_docs?student_id={{$student_id}}" target="_blank" > View Details</a></td>
		<td><a href="/SPACS/spacscom_dir_gm_form?student_id={{$student_id}}&id={{$scholarship_id}}" target="_blank" > View Details</a></td>
