...
<html>
<head>
<title>DIRECTOR SILVER GAMES</title>
<style type="text/css">
...
<form name="dir_form" action="/SPACS/dir_sil_gam_form/{{$scholarship_id}}/{{Auth::user()->username}}" method="POST">
...
<tr>
<td colspan="2">3.the level of participation in Games and Sports activities during your stay at IIITDMJ
</td>
</tr>
<tr>
...
<tr >
<td colspan="2">
<input type="checkbox" name="declare" value="declare" />I Declare all entries in this form are true to the bestof my knowledge and belief
</td>
</tr>
<td colspan="2">
