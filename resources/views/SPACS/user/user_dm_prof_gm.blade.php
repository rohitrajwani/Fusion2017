...
<body>
<h3>D&M PROFICIENCY GOLD MEDAL</h3>
<form name="dir_form" action="/SPACS/dm_prof_gm_form/{{$scholarship_id}}/{{Auth::user()->username}}" method="POST">
...
<!----- First Name ---------------------------------------------------------->
<?php
$pbi=DB::table('pbi')->where('student_id',Auth::user()->username)->get();
