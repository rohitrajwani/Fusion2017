...
@section('main_content')
        ...
        <div class="main-container row">
            <nav class="mynav">
              <div class="nav-wrapper">
                <ul>
                  ...
                  <li class="active"><a href="/ELMS/leaveApplicationFacultyLGO">Apply for Leave</a></li>
                  <li><a href="/ELMS/historyFacultyLGO">Leave History</a></li>
                  <li><a href="/ELMS/statusFacultyLGO">Check Status</a></li>
                  <li><a href="/ELMS/requestsFacultyLGO">Pending Requests</a></li>
            ...
            <form method = "post" action = "/ELMS/leaveLGO">
