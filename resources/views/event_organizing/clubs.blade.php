	...
	<div class="main-container">
		...
		<div class="container" id="buttons_div">
			...
			<div class="row">
				...
				<div class="button-container col s6"> <a href="#cancel_event" id="cancel_event_btn" class="button col s8 offset-s2"> <i class="fa fa-calendar-times-o"></i> <div class="divider col s12"></div> <h5 class="col s12">Cancel Event</h5> </a> </div>

				<div class="button-container col s6"> <a href="#" id="view_members_btn" class="button col s8 offset-s2"> <i class="fa fa-search"></i> <div class="divider col s12"></div> <h5 class="col s12">View Members</h5> </a> </div>
