...
@section('main_content')
           ...
           <li><a href="/PBI/feedback">Feedback</a></li>
				...
				<ul>
				<li><a href="cse_committee">Final Evaluation Committee CSE</a></li><li><div class="divider"></div></li>
				<li><a href="ece_committee">Final Evaluation Committee ECE</a></li><li><div class="divider"></div></li>
				<li><a href="mech_committee">Final Evaluation Committee ME</a></li><li><div class="divider"></div></li>
	  ...
	  <a class="waves-effect waves-light btn-large" href="/PBI/apply">Apply for PBI</a>
	  </div>
       <div class="col s12 m3 ">
	  <a class="waves-effect waves-light btn-large" href="/PBI/change">Change PBI</a>
	  </div>
	  </div>
				<div class="row">
				<div class="col m8">
