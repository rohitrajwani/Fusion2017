...
<p><br><br></p>
<h4> <center>Upload GradeSheet</center></h4>
<form action="/PBI/uploadgrades" method="POST" enctype="multipart/form-data">
    ...
    <div class="file-field input-field">
      <div class="btn">
        ...
        <input type="file" multiple name="grades">
    
      </div>
      <div class="file-path-wrapper">
        <input class="file-path validate" type="text"  placeholder="Upload one or more files" name="gradesheet">
      </div>
    </div>
  <div class="row">
