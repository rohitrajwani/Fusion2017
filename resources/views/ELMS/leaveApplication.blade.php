        ...
        <div class="main-container row">
            <nav class="mynav">
              <div class="nav-wrapper">
                <ul>
                  <li><a href="/ELMS/homeFaculty">HOME</a></li>
                  <li class="active"><a href="/ELMS/leaveApplicationFaculty">Apply for Leave</a></li>
                  <li><a href="/ELMS/historyFaculty">Leave History</a></li>
                  <li><a href="/ELMS/statusFaculty">Check Status</a></li>
            ...
            <form method = "post" action = "/ELMS/leave">
