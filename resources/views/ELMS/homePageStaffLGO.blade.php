...
@section('main_content')
    ...
    <nav class="mynav">
        <div class="nav-wrapper">
            <ul>
                <li class="active" class><a href="/ELMS/homeStaffLGO">HOME</a></li>
    ...
    <div class=" col s12 m12"><br>
        ...
        <pre>Department  :  {{$staffdet->department}} </pre>
        <pre>Designation :  {{$staffdet->post}} </pre>
        <pre>E-mail Id   :  {{$staffdet->email}} </pre>
