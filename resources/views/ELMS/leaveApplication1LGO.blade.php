...
@section('main_content')
        ...
        <div class="main-container row">
            <nav class="mynav">
              <div class="nav-wrapper">
                <ul>
                  ...
                  <li class="active"><a href="/ELMS/leaveApplicationStaffLGO">Apply for Leave</a></li>
                  <li><a href="/ELMS/historyStaffLGO">Leave History</a></li>
                  <li><a href="/ELMS/statusStaffLGO">Check Status</a></li>
                  <li><a href="/ELMS/requestsStaffLGO">Pending Requests<span class="badge">{{$counter}}</span></a></li>
            ...
            <form method = "post" action = "/ELMS/leave1LGO">
