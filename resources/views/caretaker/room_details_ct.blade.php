...
<!--
  ...
  Following code allows the VH caretaker to see details of every room present in VH.
...
-->
          ...
          @foreach($rooms as $room)
            <tr>          
              ...
              <td>
                ...
                <a href="/{{$room->room_no}}/change">Change</a>
              </td>
              <!-- <td>
                <?php 
  ...
  <div class="row">    
    ...
    <form action="/vhbooking/checkAvailabilityCT" method="POST">
