...
-->
        ...
        <h4 class="col s12 m4 offset-m4" style="border: transparent;">Caretaker Portal</h4>
      ...
      <div class="row">
         ...
         <div class="col s12 m8 l6 offset-m2 offset-l3">
            ...
            <div class="col s4 m4 offset-m4">
              <img src="{{URL::asset('/c1.jpg')}}" alt="" class="circle responsive-img"> <!-- notice the "circle" class -->
            </div>
