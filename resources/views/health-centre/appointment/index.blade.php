...
<div class="mar">
  <?php $count=0; ?>
    <h2 class="center-align primary-text">Previous Appointment Details</h2>
    ...
    <tbody>
      @foreach ($appointment as $appointment)
        ...
        <td><a href= "{{route('appointment.show',$appointment->appointment_id) }}" class="waves-effect btn" style="font-size:12px;">View</a>
          <center>
          {!! Form::open(['route' => ['appointment.destroy',$appointment->appointment_id],'method' => 'DELETE']) !!}
          {!! Form::submit('Delete Record',['class' => 'btn btn-danger btn-block','style' => 'font-size:12px;']) !!}
          {!! Form::close() !!}
        </center>
        </td>
      </tr>
